...
const graphicAssets = 
{
    ...
    REDBALL: { image: document.getElementById("redSpriteImage"), spriteSheet: new vector2d( 5, 1 ), numSprites: 6},
    ACIDBALL: { image: document.getElementById("acidSpriteImage"), spriteSheet: new vector2d( 5, 3 ), numSprites: 11},
};
...
const TAGS = { GAMEOBJECT: "GameObject", BASEPLAYER: "BasePlayer" }
